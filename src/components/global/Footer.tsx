  ...
  return (
    <footer className="bg-bg-header-sm p-4 text-black md:px-6 md:py-12">
      <div className="container mx-auto sm:mx-0 w-full md:px-10">
        ...
        <div className="md:grid-cols grid gap-10 md:gap-8 lg:grid-cols-3 lg:gap-4 pt-6 font-rebond text-lg md:text-3xl xl:text-lg leading-normal font-light text-black not-italic">
